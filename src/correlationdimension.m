function [fg,rcM,cM,rdM,dM,nuM] = correlationdimension(xV,tau,mmax,tittxt,fac,logrmin,logrmax);
...
eval(['!/./home/sniper/programs/Tisean_3.0.1/source_c/d2 tmp.dat -t50 -d',int2str(tau),' -M1,',int2str(mmax),' -N0 -o tmp'])
