...
Στα πρώτα βήματα δε θα χρειαστεί να εξάγουμε κάποια άλλη χρονοσειρά μέσω της βασικής, ωστόσο θα πρέπει να βρούμε την υστέρηση και τη διάσταση εμβύθισης μέσω της μεθόδου των υστερήσεων. Για να έχουμε μια εποπτεία για τα μη γραμμικά μεγέθη της χρονοσειράς κάνουμε διαγράμματα διασποράς στις δύο και στις τρεις διαστάσεις. Τα διαγράμματα αυτά φαίνονται στα σχήματα [31], [32], [33], [34].

| Διαγράμματα  | Διασποράς |
|--------------------------:|:-----|
![31](../assets/scatter_1st_xM_1_2_3.png "") | ![32](../assets/scatter_1st_xM_1_2_4.png "")
![33](../assets/scatter_1st_xM_1_2_5.png "") | ![34](../assets/scatter_1st_xM_1_2_6.png "")
...
![35](../assets/mutualinformation_1st.png "Διάγραμμα συνάρτησης αμοιβαίας πληροφορίας")

Αν η χρονοσειρά μπορούσε να εξηγηθεί από μη-γραμμική μοντελοποίηση, τότε η συνάρτηση αμοιβαίας πληροφορίας θα έπρεπε να παρουσιάζει ένα τοπικό ελάχιστο. Παρόλα αυτά στο διάγραμμα δε διακρίνεται κάποιο τοπικό ελάχιστο, αλλά μόνο ότι η συνάρτηση είναι φθίνουσα. Για να σιγουρευτούμε περί αυτού και να δούμε αν μπορούμε να συνεχίσουμε την μη γραμμική ανάλυση κάνουμε και επιπλέον διαγράμματα 2 διαστάσεων για πιο μεγάλους χρόνους υστέρησης. Αυτά φαίνονται στα σχήματα [36], [37], [38], [39], [40], [41].

| Διαγράμματα               |Διασποράς  | |
| --------------------------:|:-----|-----|
![36](../assets/scatter_1st_xM_1_2.png "") | ![37](../assets/scatter_1st_xM_1_3.png "") | ![38](../assets/scatter_1st_xM_1_4.png "")
![39](../assets/scatter_1st_xM_1_5.png "") | ![39](../assets/scatter_1st_xM_1_6.png "") | ![40](../assets/scatter_1st_xM_1_7.png "")
![41](../assets/scatter_1st_xM_1_8.png "") | ![42](../assets/scatter_1st_xM_1_9.png "") | ![43](../assets/scatter_1st_xM_1_10.png "")

Από αυτά καταλαβαίνουμε πως η μη-γραμμική ανάλυση που θα πραγματοποιήσουμε στη συνέχεια, από καθαρή περιέργεια, πρόκειται να αποτύχει. Για την επιλογή του $\tau$ παίρνουμε την τιμή που η $I(\tau)$ κάνει αγκώνα. Δηλαδή $\tau=10$. 
...
<!-- και του αλγορίθμου DBSCAN (εκτός ύλης) για `epsilon=0.5` και `MinPts=10` ο οποίος βρίσκει τους ελκυστές που δημιουργούνται για τα σημεία της χρονοσειράς για δύο διαστάσεις εμβύθισης με δεδομένη υστέρηση.  -->

![44](../assets/false_nearest_calc_plot_1st.png "")

| Διαγράμματα               |Διασποράς  |
| --------------------------:|:-----|-----|
![45](../assets/scatter_1st_with_tau_xM_1_2.png "") | ![46](../assets/scatter_1st_with_tau_xM_1-3.png "")
![47](../assets/scatter_1st_with_tau_xM_1_4.png "")
...
![48](../assets/cor_dim_plot_1st.png "Διάσταση υστέρησης για διάφορα m και r")

Το μόνο που μένει να κάνουμε ακόμα στο μοντέλο αυτής της χρονοσειράς είναι να δούμε την προβλεπτική του ικανότητα. Αυτή θα τη δούμε χρησιμοποιώντας κάποιο κατάλληλο τοπικό μοντέλο που βασίζεται σε κοντινότερους γείτονες. Η πρόβλεψη γίνεται για 1 έως και 10 βήματα μπροστά στο Σχήμα [49] χρησιμοποιώντας τους 3 κοντινότερους γείτονες. Ως σφάλμα πρόβλεψης χρησιμοποιούμε το NRMSE, ώστε να μπορέσουμε να συγκρίνουμε και με τα γραμμικά μοντέλα.


![49](../assets/local_model_fit_1st.png "Μη γραμμική πρόβλεψη")
