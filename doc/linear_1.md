...
![1](../assets/basic_plot_1st.png "Χρονοσειρά 1")
...
![10](../assets/autocorrelation_TMI1.png "Συνάρτηση αυτοσυσχέτισης")

![11](../assets/partial_autocorrelations_TMI1.png "Συνάρτηση μερικής αυτοσυσχέτισης")
...
AIC για τα υποψήφια AR μοντέλα | AIC για τα υποψήφια MA μοντέλα
:-------------------------:|:-------------------------:
![12](../assets/MA_AIC_TMI1.png "AIC για τα υποψήφια AR μοντέλα")  |  ![13](../assets/AR_AIC_TMI1.png "AIC για τα υποψήφια MA μοντέλα") 
---
![14](../assets/ARMA_AIC_TMI1.png "AIC για τα υποψήφια ARMA μοντέλα")


![15](../assets/ARMA_best_pred_TMI1.png "Προβλέψεις τιμών για το καλύτερο μοντέλο")

Εν τέλει η πρόβλεψη είναι πάλι χειρότερη από τη μέση τιμή. Γενικά καταλήγουμε πως αυτή η μέθοδος μελέτης ακροτάτων για αυτή τη χρονοσειρά δεν μπόρεσε να παράξει ιδιαίτερα αποτελέσματα. Σε αυτό οφείλεται ότι τα τοπικά ακρότατα δεν μπορούσαν να προσσεγγιστούν γραμμικά ή στην δεύτερη περίπτωση ήταν λίγα σε αριθμό. Αυτό βέβαια δε σημαίνει πως η μελέτη μας σταμάτησε εδώ. Στο δεύτερο κομμάτι της εργασίας θα προσπαθήσουμε να κάνουμε μία μη γραμμική ανάλυση της χρονοσειράς και να εξάγουμε αποτελέσματα για τη συμπεριφορά της.   